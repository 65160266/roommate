-- Chat System Tables Only (Fixed Version)
...
-- Note: Using IF NOT EXISTS to prevent errors if indexes already exist
...
DROP TRIGGER IF EXISTS update_chatroom_timestamp;
...
DROP PROCEDURE IF EXISTS GetOrCreateChatRoom;
...
SHOW PROCEDURE STATUS WHERE Name IN ('GetOrCreateChatRoom', 'GetUserChatRooms');
